...
public class Constants {
    ...
    public static final String PAGE_NUMBER_ARTICLE = "1";
    public static final String PAGE_NUMBER_TOP_ARTICLES = "1";
    public static final String ID_ARTICLE = "280146";
    public static final String ID_TOP_ARTICLES = "0";
