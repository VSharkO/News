...
public class HomeFragmentOtherPagesModule {
    ...
    @PerFragment
    @Provides
    HomeFragmentOtherPagesImpl provideHomeOtherItemsFragment(HomeFragmentOtherPagesImpl fragment){
        return fragment;
    }

    @PerFragment
    @Provides
    FragmentManager provideManager(HomeFragmentOtherPagesImpl fragment){
